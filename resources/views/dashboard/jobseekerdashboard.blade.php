    ...
    <body class="antialiased">
                ...
                <div class="container mt-3">
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-2 mb-3">
                            <select id="seeker_location" name="location" class="form-select">
                            </select>
                        </div>
                        <div class="col-md-2 mb-3">      
                      ...
                      <form id="editJobForm">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="row">
                            <div class="mb-3">
                                <label for="skills" class="form-label">Skills Required</label>
                                <textarea class="form-control" id="editskills_required" name="skills_required" rows="3"></textarea>
                            </div>
                          </div>
                          <div class="row">
                              <div class="mb-3">
